...
<template lang="pug">
div(class="h-20")
  div(class="h-full flex items-center justify-around gap-10 p-4  border-b-2 border-gray-300 shadow  drop-shadow-gray-200") 
    ...
    router-link(to="/" class="font-extrabold text-white text-2xl md:text-1xl ") SHOP.CO
